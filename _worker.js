...
const Pages静态页面 = 'https://raw.githubusercontent.com/Yusuf-Ardiansyah/IP/refs/heads/main/panel.html';
///////////////////////////////////////////////////////全局常量和工具函数///////////////////////////////////////////////
...
export default {
	async fetch(request, env, ctx) {
		...
		const 管理员密码 = '94c33f53-415a-4eb7-b588-4230a45cf72f';
		const 加密秘钥 = env.KEY || '勿动此默认密钥，有需求请自行通过添加变量KEY进行修改';
		const userIDMD5 = await MD5MD5(管理员密码 + 加密秘钥);
		const uuidRegex = /^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/;
		const envUUID = '94c33f53-415a-4eb7-b588-4230a45cf72f';
...
async function 读取config_JSON(env, hostname, userID, UA = "Mozilla/5.0", 重置配置 = false) {
	...
	const host = hostname, Ali_DoH = "https://dns.alidns.com/dns-query", ECH_SNI = "cloudflare-ech.com", 占位符 = '{{IP:PORT}}', 初始化开始时间 = performance.now(), 默认配置JSON = {
		...
		订阅转换配置: {
			...
			SUBCONFIG: 'https://raw.githubusercontent.com/Yusuf-Ardiansyah/IP/refs/heads/main/config-clash.ini',
			SUBEMOJI: false,
...
async function 生成随机IP(request, count = 16, 指定端口 = -1) {
	...
	const cidr_url = 'https://raw.githubusercontent.com/Yusuf-Ardiansyah/IP/refs/heads/main/Proxy-CIDR.txt';
